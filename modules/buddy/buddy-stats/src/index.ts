...
async function main(): Promise<void> {
	...
	if (values.help) {
		console.log(`
buddy-stats - AI Usage Statistics Dashboard
...
Examples:
  buddy-stats              # Start dashboard server
  buddy-stats --json       # Print stats as JSON
  buddy-stats --port 8080  # Start on custom port
  buddy-stats --sync       # Sync and show summary
`);
		return;
	}
