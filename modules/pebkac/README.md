# PEBKAC — the per-agent runtime guard
...
PEBKAC loads as a Bun extension into your coding harness (the agent harness, and
anything that speaks the harness extension protocol). Once loaded, every agent
session gets:
...
This installs the extension to `.mouthpeace/extensions/pebkac-defense.js`, creates
...
.mouthpeace/extensions/pebkac-defense.js       (Bun/Node.js defense extension)
.harness/
