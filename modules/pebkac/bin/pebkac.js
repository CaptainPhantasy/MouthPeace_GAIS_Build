...
function ensureProject(targetCwd) {
  mkdirSync(join(targetCwd, ".mouthpeace", "extensions"), { recursive: true });
...
function init() {
  ...
  copyFileSync(join(repoRoot, ".mouthpeace", "extensions", "pebkac-defense.js"), join(targetCwd, ".mouthpeace", "extensions", "pebkac-defense.js"));
...
function status() {
  const targetCwd = resolve(optionValue("--cwd", process.cwd()));
  const extensionPath = join(targetCwd, ".mouthpeace", "extensions", "pebkac-defense.js");
